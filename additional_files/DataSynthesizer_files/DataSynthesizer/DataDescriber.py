...
from DataSynthesizer.lib.PrivBayes import greedy_bayes,fair_greedy_bayes, construct_noisy_conditional_distributions
...
class DataDescriber:
    ...
    def describe_dataset_in_fair_correlated_attribute_mode(self,
                                                      dataset_file,
                                                      k=0,
                                                      epsilon=0.1,
                                                      attribute_to_datatype: Dict[str, DataType] = None,
                                                      ...
                                                      categorical_attribute_domain_file: str = None,
                                                      numerical_attribute_ranges: Dict[str, List] = None,
                                                      attribute_to_sensitive: Dict[str,List] = None,
                                                      seed=0):
        """Generate dataset description using correlated attribute mode.
        ...
        seed : int or float
            Seed the random number generator.
        attribute_to_sensitive: dict
            Dictionary of {sensitivity: attribute} e.g, {"admissible": ["age","education","relation"], "inadmissible": ["sex"], "outcome":["income"]}
        """
        self.describe_dataset_in_independent_attribute_mode(dataset_file,
                                                            epsilon,
                                                            attribute_to_datatype,
        ...
        self.bayesian_network = fair_greedy_bayes(self.df_encoded, k, epsilon / 2, seed=seed, sensitive = attribute_to_sensitive)
        self.data_description['bayesian_network'] = self.bayesian_network
        self.data_description['conditional_probabilities'] = construct_noisy_conditional_distributions(
            self.bayesian_network, self.df_encoded, epsilon / 2)
